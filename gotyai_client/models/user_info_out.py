...
class UserInfoOut(object):
    ...
    attribute_map = {
        ...
        'email_verified_ip_address': 'emailVerifiedIpAddress',
    ...
    def __init__(self, uid=None, email=None, phone_number=None, email_verified=None, display_name=None, photo_url=None, disabled=None, first_known_ip_address=None, email_verified_ip_address=None, provider_id=None, time_stamp=None, verify_token=None, api_key=None, stripe_perishable_key=None, stripe_customer_id=None, other_infos=None, disposable_email=None):  # noqa: E501
        ...
        self._email_verified_ip_address = None
        ...
        if email_verified_ip_address is not None:
            self.email_verified_ip_address = email_verified_ip_address
        ...
        if disposable_email is not None:
            self.disposable_email = disposable_email
    ...
    @property
    def email_verified_ip_address(self):
        """Gets the email_verified_ip_address of this UserInfoOut.  # noqa: E501


        :return: The email_verified_ip_address of this UserInfoOut.  # noqa: E501
        :rtype: str
        """
        return self._email_verified_ip_address

    @email_verified_ip_address.setter
    def email_verified_ip_address(self, email_verified_ip_address):
        """Sets the email_verified_ip_address of this UserInfoOut.


        :param email_verified_ip_address: The email_verified_ip_address of this UserInfoOut.  # noqa: E501
        :type: str
        """

        self._email_verified_ip_address = email_verified_ip_address
    ...
    @property
    def disposable_email(self):
        """Gets the disposable_email of this UserInfoOut.  # noqa: E501


        :return: The disposable_email of this UserInfoOut.  # noqa: E501
        :rtype: bool
        """
        return self._disposable_email

    @disposable_email.setter
    def disposable_email(self, disposable_email):
        """Sets the disposable_email of this UserInfoOut.


        :param disposable_email: The disposable_email of this UserInfoOut.  # noqa: E501
        :type: bool
        """

        self._disposable_email = disposable_email
